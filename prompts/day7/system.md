...
3. **第 5 题"我完全不知道的"字段必须严格逐字使用 unknown_concepts_list 中某一项原文** — 不要改写、不要换近义词、不要泛化（如把"公园"写成"户外的地方"会被判错）。可以围绕这个词写一两句感受，但 unknown_thing 字段本身必须含原词。
...
例：
- unknown_concepts_list 含「公园」→ unknown_thing 可以写「我从来没去过公园。」 ✓
- unknown_concepts_list 含「公园」→ unknown_thing 写「我没去过的地方」 ✗（没有原词，会被判错）
